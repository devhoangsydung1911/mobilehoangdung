          ...
          <div>
            <ul class="flex items-center gap-x-7">
              <li>
                <router-link :to="{ name: 'cart' }" class="flex items-center">
                  ...
                  <div class="text-center">
                    <span>
                      <p class="rounded-xl bg-sky-600 text-white font-semibold">
                        {{ this.itemsCount }}
                      </p>
                      <p>Giỏ Hàng</p>
                    </span>
              ...
              <li class="flex justify-center items-center show">
                ...
                />
                <a
                  v-show="this.user.role_id == 1 ? false : true"
                  href="/login"
                ...
                <div class="inline-block">
                  ...
                  >
                    <button @click="logout()" class="w-full py-1">
                      Đăng xuất
                    </button>
                  </div>
                </div>
    ...
    <section>
      ...
      <div class="layout-container">
        <div class="flex justify-center items-center gap-x-14">
          ...
          <div id="mybtn" class="flex justify-center items-center gap-x-14">
            <router-link
              to="/"
